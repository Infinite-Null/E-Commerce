...
export function EachOrderItem({image,name,price,quantity,id}) {
    return (
        <div className="mt-4 md:mt-6 flex  flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full ">
            <div className="pb-4 md:pb-8 w-full md:w-40">
                <img className="w-full hidden md:block" src={image} alt="Cloth" />
                <img className="w-full md:hidden" src={image} alt="Cloth" />
            </div>
